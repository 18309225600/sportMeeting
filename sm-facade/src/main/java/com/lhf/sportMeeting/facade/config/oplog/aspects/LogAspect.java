package com.lhf.sportMeeting.facade.config.oplog.aspects;

import com.lhf.sportMeeting.common.utils.SessionUtils;
import com.lhf.sportMeeting.domain.entity.Log;
import com.lhf.sportMeeting.domain.enums.Status;
...
public class LogAspect {
     ...
     * 日志切入点
     */
    @Pointcut(value = "@annotation(com.lhf.sportMeeting.facade.config.oplog.annotations.OpLog)")
